...
class Factory {
    ...
    //this is a class func, vs an instance function
    class func createSlots() -> [[Slot]]{
        ...
        for var containerNumber = 0; containerNumber < kNumberOfContainers; ++containerNumber {
            ...
            for var slotNumber = 0; slotNumber < kNumberOfSlots; ++slotNumber {
                var slot = createSlot(slotArray) //Slot(value:0, image: UIImage(named:""), isRed: true)
    ...
    class func createSlot (currentCards : [Slot]) -> Slot {
        ...
        var slot:Slot
        //no need to specify file extensions anymore because how we imported the pics
        switch randomNumber {
        case 0:
